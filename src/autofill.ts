...
(function() {
  const fields = [
    ...
    { id: 'input-fhack', value: 'Free Christmas Postcards as a business: During Christmas of 2024, a German postcard company offered a voucher to send one free postcard per account. However, the system lacked two-factor authentication and treated Gmail aliases (using the "+" symbol) as unique addresses. I automated the signup process using an Android emulator and mass-generated Gmail aliases, eventually creating thousands of accounts. The system went viral at our University, and we sent so many postcards that I thought of actually opening my own printing service. Surprising friends with fun and lovely mail.' },
    { id: 'input-test-scores', value: 'SAT: 1550/1600, TOEFL: 117/120, Abitur: 1.7, ranked Top 5% at CODE University Berlin, DAAD Scholar (awarded for academic excellence and leadership by the German Academic Exchange Ministry), Selected for Stanford University Exchange Program.' },
